 ...
 * senão, calcula YTD on-the-fly (jan→M, só receitas conta_para_share=true).
 *
 ...
 * Se já existe snapshot para a competencia, retorna erro (use reopen primeiro).
 */
